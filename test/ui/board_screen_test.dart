...
import 'package:clean_kanban/domain/entities/board.dart'; // added import
...
void main() {
  ...
  testWidgets('BoardScreen shows loading indicator then board UI', (WidgetTester tester) async {
    ...
    boardProvider.board = boardProvider.board ?? BoardProvider().board ?? Board.simple();
